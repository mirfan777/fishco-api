...
<body class="bg-white relative">
    <!-- Main Section -->
    <section class="relative h-screen bg-[#F4FAFF] p-6 pt-10 animate-fadeIn">
    ...
    <!-- Tentang Kami -->
    <section class="bg-white-100 py-16 px-4 sm:px-6 lg:px-8 w-[90%] lg:w-[70%] mx-auto animate-fadeIn">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="flex justify-center">
                    <img src="{{'/images/landing/fitur_andalan1.png'}}" alt="Phone with Fish"
                        class="w-40 md:w-[8rem] lg:w-[16rem] object-cover">
                </div>

                <!-- Text Column 2, Row 1 -->
                <div class="space-y-4">
                    <h3 class="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 leading-tight">Scanner Penyakit
                        Ikan</h3>
                    <p class="text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed mt-4">Dengan sekali klik, scanner
                        ini dapat mendeteksi penyakit yang dimiliki oleh ikan hias peliharaanmu secara akurat dan cepat!
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed mt-4">Tidak puas dengan hasil
                        scan? Fishbot siap menjawab pertanyaanmu dan memberi solusi terbaik kapan saja, 24/7!</p>
                </div>
