                ...
                <form id="createArticleForm" class="w-full" method="POST" enctype="multipart/form-data">
                    <div class="flex flex-col w-full gap-5">
                        <div class="w-full">
                            ...
                            <!-- Title -->
                            <div class="mb-3">
                                <label for="create-article-title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="create-article-slug" name="slug" class="bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly />
                            </div>
                            <!-- Description/Body -->
                            <div class="mb-3">
                                <label for="create-article-body" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Badan Artikel</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#create-article-title').on('input', function() {
            const title = $(this).val();
            const slug = generateSlug(title);
            $('#create-article-slug').val(slug);
        });
