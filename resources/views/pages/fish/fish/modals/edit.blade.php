                    ...
                    <div class="flex flex-col md:flex-row md:justify-between w-full gap-5">
                        ...
                        <div class="md:w-1/2">
                            ...
                            <div>
                                <!-- Food Type -->
                                <div class="mb-3">
                                    <label for="edit-food_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipe Makanan</label>
                            ...
                            <div>
                                <!-- Habitat -->
                                <div class="mb-3">
                                    <label for="edit-habitat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Habitat</label>
                                ...
                                <!-- Min Temperature -->
                                <div class="mb-3">
                                    <label for="edit-min_temperature" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Min Temperature</label>
                                ...
                                <!-- Max Temperature -->
                                <div class="mb-3">
                                    <label for="edit-max_temperature" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Max Temperature</label>
                                ...
                                <!-- Min size -->
                                <div class="mb-3">
                                    <label for="edit-min_ph" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Min Size</label>
                                    <input type="number" step="0.1" id="edit-min_size" name="min_size" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan ukuran min" required />
                                </div>

                                <!-- Max size -->
                                <div class="mb-3">
                                    <label for="edit-max_ph" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Max Size</label>
                                    <input type="number" step="0.1" id="edit-max_size" name="max_size" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan ukuran max" required />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#edit-fish form').on('submit', function (e) {
            ...
            formData.append('min_size', $('#edit-min_size').val());
            formData.append('max_size', $('#edit-max_size').val());
