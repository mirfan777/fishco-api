    ...
    <main class="min-h-screen pt-12 sm:ml-64 bg-gray-50">
        <div class="container mx-auto p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600 dark:text-gray-400">
                                    ...
                                    <p><span class="font-medium w-32 inline-block">pH Air:</span> <span id="detail-ph"></span></p>
                                    <p><span class="font-medium w-32 inline-block">Kegaraman Air:</span> <span id="detail-salinity"></span></p>
                                </div>
            ...
            <ul id="navbar" class="flex justify-left border-b mt-10 border-gray-200 dark:border-gray-700 text-gray-500 text-sm font-medium">
                <li class="mr-2">
                    <a data-status="0" class="inline-block p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500">Ikan Sehat</a>
                </li>
                <li class="mr-2">
                    <a data-status="1" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Ikan Sakit</a>
                </li>
            </ul>
...
<script>
    ...
    $('#navbar a').on('click', function (e) {
        ...
        $('#navbar a').removeClass('text-blue-600 bg-gray-100 dark:text-blue-500 dark:bg-gray-800 active');
        $(this).addClass('text-blue-600 bg-gray-100 dark:text-blue-500 dark:bg-gray-800 active');
    ...
    function loadFishData(fishId) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#detail-temperature').text((fish.min_temperature != null && fish.max_temperature != null) ? `${fish.min_temperature}°C - ${fish.max_temperature}°C` : "Not available");
                ...
                $('#detail-min_aquarium').text(fish.min_water_volume != null ? `${fish.min_water_volume} L` : "Not available");
                ...
                $('#edit-max_temperature').val(fish.max_temperature != null ? fish.max_temperature : "Not available");
                $('#edit-min_ph').val(fish.min_ph != null ? fish.min_ph : "Not available");
                $('#edit-max_ph').val(fish.max_ph != null ? fish.max_ph : "Not available");
                ...
                $('#edit-min_aquarium').val(fish.min_water_volume != null ? fish.min_water_volume : "Not available");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (filteredImages.length === 0) {
                    $('#fish-images').append('<p class="text-center text-gray-500 dark:text-gray-400">Data foto kosong</p>');
                } else {
                        ...
                        $('#fish-images').append(`
                            <div class="relative max-w-xl mx-auto group">
                                ...
                                <div class="group-hover:visible invisible absolute inset-0 flex items-center justify-center">
                                    <button onClick='getImageId(${image.id})' class="flex gap-1 item-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
