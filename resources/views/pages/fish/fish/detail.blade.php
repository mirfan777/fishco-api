    ...
    <main class="sm:ml-64 min-h-screen mt-20 bg-gray-50">
        <div class="flex flex-col lg:flex-row gap-2 mb-5 lg:p-20 p-2">
            <div class="lg:w-60 lg:h-60 w-80 h-80 md:mx-10">
                <img id="main-fish-image" class="rounded-lg w-80 h-80 lg:w-60 lg:h-60" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image.jpg" alt="alt">
            </div>
            <div class="flex flex-col justify-center">
                <h1 id="fish-name" class="text-title text-4xl">Fish Name</h1>
                ...
                <div class="flex md:flex-row flex-col w-full gap-5 mt-5">
                    <button data-modal-target="upload-image" data-modal-toggle="upload-image" class="button">Tambah data foto</button>
                    <button data-modal-target="edit-fish" data-modal-toggle="edit-fish" class="button">Edit data</button>
                    <button data-modal-target="delete-fish" data-modal-toggle="delete-fish" class="button">Hapus data</button>
                </div>
            </div>
        </div>
