                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                          <!-- TAMBAH DATA -->
                          <button data-modal-target="create-medicine" data-modal-toggle="create-medicine" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                            Tambah data
                          </button>
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-left">
                                            ...
                                            <th scope="col" class="px-4 py-3">Disease Treated</th>
                                            <!-- <th scope="col" class="px-4 py-3">Side Effects</th> -->
                                    ...
                                    <tbody class="text-left"> 
                                        <!-- Data Dummy -->
                                        <tr>
                                            <td class="px-4 py-3">PraziPro</td>
                                            <td class="px-4 py-3">Cacing Parasit</td>
                                            <td class="px-4 py-3">
                                        ...
                                        <tr>
                                            <td class="px-4 py-3">Ich-X</td>
                                            <td class="px-4 py-3">Penyakit Bintik Putih (Ich)</td>
                                            <td class="px-4 py-3">
                                                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Detail</button>
                                                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded">Hapus</button>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="px-4 py-3">Melafix</td>
                                            <td class="px-4 py-3">Luka Luar, Infeksi Sirip</td>
                                            <td class="px-4 py-3">
                                                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Detail</button>
                                                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded">Hapus</button>
                                            </td>
