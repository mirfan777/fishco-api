<!-- Main modal -->
<div id="edit-disease" tabindex="-1" aria-hidden="true" data-modal-target="edit-disease" class="hidden overflow-x-hidden fixed top-0 right-0 left-0 z-[99999] bg-black bg-opacity-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)]">
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form id="edit-disease-form" class="w-full">
                    <div class="flex flex-col md:flex-row md:justify-between w-full gap-5">
                        <div class="md:w-1/2">
                            <!-- Name -->
                            <div class="mb-3">
                                <label for="edit-disease-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Penyakit</label>
                            ...
                            <!-- Symtomps -->
                            <div class="mb-3">
                                <label for="edit-disease-symptoms" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gejala</label>
                                <input type="text" id="edit-disease-symptoms" name="symptoms" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter disease symptoms" required />
                            </div>
                        </div>
                        ...
                        <div class="md:w-1/2">
                            <!-- Description -->
                            <div class="mb-3">
                                <label for="edit-disease-description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
...
$(document).ready(function() {
    ...
    $('#edit-disease-form').on('submit', function(e) {
        ...
        const formData = {
            ...
            symptoms: $('edit-disease-symptoms').val(),
            description: $('#edit-disease-description').val(),
        };
